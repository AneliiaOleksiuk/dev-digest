...
export class DrizzleSkillsRepository implements SkillsRepository {
   ...
   * skill_versions — name/description/type/enabled edits don't (they aren't
   * part of what the skill injects into a prompt).
   */
  async update(
    workspaceId: string,
    id: string,
